...
const Announcement = () => {
  ...
  return (
    ...
    <Text>
      ...
      <Button onClick={href="https://img.freepik.com/foto-gratis/bandera-argentina_1401-57.jpg?w=900&t=st=1653776668~exp=1653777268~hmac=dbdb6438a3d70e61e393ce3b127d03ce566cdbb240e3a5fc3d7207210dbbfadb" height ="40" width="100"}  />
        <ContactMail />
      </Button>
      <Button>
      <PhonePaused />
