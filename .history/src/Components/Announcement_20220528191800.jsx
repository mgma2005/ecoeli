  ...
  return (
    ...
    <Text>
       ...
       <script type="text/javascript"> 
        function showHide()
        { ImageDiv=document.getElementById('myimageDiv') set display to inline if currently none, otherwise to none oImageDiv.style.display=(oImageDiv.style.display=='none')?'inline':'none' } 
        </script>
      <Button >
        <ContactMail />
      </Button>
